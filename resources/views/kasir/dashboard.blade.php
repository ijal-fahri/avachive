        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 col-span-1 md:col-span-2">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="text-center p-4 bg-yellow-50 rounded-lg">
                        <p class="text-sm text-yellow-600">Pelanggan Baru</p>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center p-4 hover:bg-gray-50 rounded-lg transition cursor-pointer">
            ...
            <div class="p-6">
                <form id="formPelanggan" action="{{ route('pelanggan.store') }}" method="POST" class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-4">
                            <label for="kodepos" class="block text-sm font-medium text-gray-700 mb-1">Kode
                                Pos</label>
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        <button type="button" id="cancelBtn"
                            class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition">Batal</button>
                        <button type="submit"
...
<div class="ml-0 lg:ml-64 min-h-screen p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            <h2 class="text-xl font-semibold mb-6 text-gray-800">Kelola Laundry</h2>
            <div class="grid grid-cols-2 gap-4">
                <a href="" class="text-center p-4 hover:bg-gray-50 rounded-lg transition cursor-pointer">
                    <div class="text-blue-600 text-3xl mb-2">
                        <i class="fas fa-shopping-bag"></i>
                    </div>
                    <p class="text-sm font-semibold">Layanan</p>
