...
<body>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Kasir</td>
              <td><span style="color:green; font-weight:600;">Aktif</span></td>
              <td class="aksi-buttons">
                <button class="btn-detail"><i class="bi bi-eye"></i></button>
                <button class="btn-edit" onclick="openForm('Budi Santoso','budi@gmail.com','Kasir')"><i class="bi bi-pencil"></i></button>
              </td>
            </tr>
          </tbody>
        </table>
  ...
  <script>
    function openForm(nama = '', email = '', role = 'Kasir') {
      document.getElementById('userModal').style.display = 'flex';
      document.getElementById('modalTitle').innerText = nama ? 'Edit Karyawan' : 'Tambah Karyawan';
